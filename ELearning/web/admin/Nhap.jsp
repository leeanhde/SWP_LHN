            ...
            <jsp:include page="sidebar.jsp"></jsp:include>
                ...
                <div class="wrapper d-grid gap-20">
                    ...
                    <div class="search-items p-20 bg-white rad-10">
                        <h2 class="mt-0 mb-20">List Category</h2>
                        <div class="items-head d-flex space-between c-grey mb-10">
                            <div>Name</div>
                            <div>Count Course</div>
                        </div>
                        <c:forEach items="${listCategory}" var="listCategory"> 
                            <div class="items d-flex space-between pt-15 pb-15">
                                <span>${listCategory.categoryName}</span>
                                <span class="bg-eee fs-13 btn-shape">${listCategory.getCourseCount()}</span>
                            </div>
                        </c:forEach>
                        ...
                        <div class="items-head d-flex space-between c-grey mb-10">
                            <div>
                                ...
                                <script>
                                    ...
                                    var legendText = document.createTextNode(" " + categoryName);
                                ...
                                <c:forEach items="${listCategory}" var="listCategory">
                                    <ul class="m-0 p-relative">
                                        <li class="mt-25 d-flex align-center done">
                                            <div class="legend-color-box" style="background-color: ${colors[status.index]};">${listCategory.categoryName}</div>
